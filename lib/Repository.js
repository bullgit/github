...
class Repository extends Requestable {
  ...
  /**
    ...
    * @param {string} endpoint - endpoint of traffic data
    * @param {Requestable.callback} [cb] - will receive the list of projects
    * @return {Promise} - the promise for the http request
    */
   listTraffic(endpoint, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/traffic/${endpoint}`, {AcceptHeader: 'inertia-preview'}, cb);
   }
